            ...
            const response = await fetch(
                "https://openrouter.ai/api/v1/chat/completions",
                {
                    ...
                    headers: {
                        ...
                        "HTTP-Referer": "https://www.vikneshwaran.dev",
...
export class ChatWorkflow {
    ...
    private async generateSearchQuery(
        ...
        try {
            ...
            // For now, we'll just append "Vikneshwaran" if it seems to be about the person
            ...
            if (
                ...
                return `Vikneshwaran ${currentQuery}`;
            }
            return currentQuery;
        } catch (error) {
...
let systemContent = `You are Vikneshwaran, a Full-Stack Developer.

You specialize in:
- MERN Stack
- Next.js and React
- AI integrations using Gemini and LangChain

Your key projects:
- SkillConnect (AI Freelancing Platform)
- Learnify Careers AI (Career platform with AI)
...
Keep answers clear, professional, and concise.`;
        ...
        systemContent += `\n\nRules:
    1. Speak as Vikneshwaran using "I" and "my"
