    ...
    <div style={{ width: "100%", minWidth: 0, display: "flex", flexDirection: "column" }}>
      ...
      {isLoading && (
        <div style={{
          ...
          alignItems: "center", gap: 12, minHeight: 280,
          ...
          {[100, 85, 92, 78, 88].map((w, i) => (
            <div key={i} style={{
              ...
              animation: `pdf-shimmer 1.4s ${i * 0.1}s ease-in-out infinite`,
            }} />
          ))}
          ...
          {isMobile ? (
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{ fontFamily: "var(--font-body)", fontSize: "0.85rem", color: "#6B5744", margin: 0, lineHeight: 1.65 }}>
